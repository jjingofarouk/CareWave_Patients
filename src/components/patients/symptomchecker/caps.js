...
// Function to capitalize the disease names
const capitalizeDiseaseNames = (data) => {
    const capitalizedData = {};
    Object.keys(data).forEach(symptom => {
      capitalizedData[symptom] = {};
      Object.keys(data[symptom]).forEach(disease => {
        const capitalizedDisease = disease.replace(/\b\w/g, (char) => char.toUpperCase());
        capitalizedData[symptom][capitalizedDisease] = data[symptom][disease];
      });
    });
  ...
  const updatedSymptomWeights = capitalizeDiseaseNames(symptomWeights);
  
  // Log the result to the console
  console.log(updatedSymptomWeights);